...
function generateBaseSchedules(faculty) {
  var bases = {};
...
function generateMonthFromBase(base, faculty, withOverrides) {
  var month = {};
  faculty.forEach(function(f) {
    month[f.id] = {};
    WEEKS.forEach(function(w) {
...
function calculateMetrics(faculty, schedule) {
...
function getCellBgClass(activity, isOverride, isBulkSelected) {
...
function getCellBorderClass(isEditing, isBulkSelected, isOverride) {
